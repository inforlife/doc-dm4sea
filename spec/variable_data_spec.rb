RSpec.describe VariableData do
  let(:cgmp_batch)        { spy('cGMP batch', codeprod: '12-000000', batch: 'LOT1', dataprod: Date.new(2017,11,18),  datascaden: Date.new(2020,11,18)) }
  ...
  context '#to_s' do
    it 'returns its attributes as atring' do
      expect(VariableData.new(cgmp_batch).to_s).to eq('%93%12-000000%10%LOT1%11%18/11/2017%17%18/11/2020%37%100')
    end
  end
